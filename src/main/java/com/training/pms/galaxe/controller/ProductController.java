...
public class ProductController {
	...
	@DeleteMapping("{productId}")                            //http://localhost:9090/product/198
    public ResponseEntity<String> deleteProduct(@PathVariable("productId")Integer productId) {
        ...
        if(productService.isProductExists(productId)) {
            ...
            responseEntity = new ResponseEntity<String>("Product not available",HttpStatus.NOT_FOUND);
        }
        return responseEntity;
    }
	...
	public ResponseEntity<String> updateProduct(@RequestBody Product product) {
		  ResponseEntity<String> responseEntity=null;
	        if(productService.isProductExists(product.getProductId())) {
	            ...
	            responseEntity = new ResponseEntity<String>("Product not available , we cannot update",HttpStatus.NOT_FOUND);
	        }
	        return responseEntity;
	    }
